...
class AggregationScan extends Base
{
     ...
     */
    public function relationRefund($outTradeNo, $totalAmount, $ip, array $extraData = [])
    {
        // 请求包体
        $reqData = array_merge([
            'merchant_no' => $this->options['merc_id'],
     ...
     */
    public function relationIdmrefund($outRefundOrderNo, $totalAmount, $ip, array $extraData = [])
    {
        // 请求包体
        $reqData = array_merge([
            'merchant_no' => $this->options['merc_id'],
